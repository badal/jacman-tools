...
module JacintheManagement
  module GuiQt
    ...
    class IpManagerCentralWidget < CentralWidget
      # version of the collective_manager
      VERSION = '0.1.0'
      # "About" specific message
      SPECIFIC = [
        "   jacman_ip : #{JacintheManagement::IP::VERSION}",
        "   ip manager : #{VERSION}"
      ]
      # "About message"
      ...
      #   add_layout(box)
      #   load_button = Qt::PushButton.new('Charger')
      #   box.add_widget(load_button)
      #   connect(load_button, SIGNAL_CLICKED) { load_ip_table }
      # end
      ...
      def build_query_line
        ...
        @query = Qt::LineEdit.new('147.210.130.21')
